...
SOURCES += src/app.c src/jt_scales.c src/scale_factory.c src/grid.c src/pads_and_midi_controller.c src/transpose_handler.c src/key_sig_handler.c src/layout_handler.c src/scale_type_handler.c
